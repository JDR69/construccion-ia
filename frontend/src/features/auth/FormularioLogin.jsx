  ...
  return (
    <>
      <form
        ...
        className="w-full max-w-[380px] text-center bg-white/5 border border-white/10 rounded-2xl px-8 backdrop-blur"
      >
